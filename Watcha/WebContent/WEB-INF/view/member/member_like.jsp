					...
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<p id="buttonGroup">
								...
								<a  href="delete_like?pageNo=${param.pageNo}&movieId=${moviePre.movieId}" class="btn btn-default" role="button"><img src="images/GrayHeart.PNG" width="20px;"></a>
							</p>
						</div>
					</div>
				</div>
